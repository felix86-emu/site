...
For a long time `apt`, the Ubuntu package manager, would be flaky on felix86. Packages would install, but often you would see a Segmentation fault happen after they finish installing, which was unpleasant and confusing.
...
The felix86 REPL can now color code each translation for easily understanding which RISC-V instruction corresponds to which x86 instruction.
