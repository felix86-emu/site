...
<div class="compat-container">
  <style>
    ...
    .game-card:has(.game-title a:focus-visible) {
      outline: 2px solid var(--accent-color);
      outline-offset: 2px;
    }
    ...
    .status.green { background: #d4edda; color: #155724; border: 1px solid #a9d9b8; }
    .status.yellow { background: #fff3cd; color: #856404; border: 1px solid #ecd9a0; }
    .status.red { background: #f8d7da; color: #721c24; border: 1px solid #eeb2b8; }
    .status.gray { background: #e2e3e5; color: #383d41; border: 1px solid #c6c8cb; }
...
<div class="game-card" data-category="working">
  ...
  <div class="game-info">
    <h3 class="game-title"><a href="https://github.com/felix86-emu/compatibility-list/issues/166">TEKKEN 7</a></h3>
...
<div class="game-card" data-category="partial">
  <div class="game-image-container">
    <img loading="lazy" src="{{ site.baseurl }}/images/compatibility/164.jpg" alt="osu!" class="game-image">
  </div>
  <div class="game-info">
    <h3 class="game-title"><a href="https://github.com/felix86-emu/compatibility-list/issues/164">osu!</a></h3>
...
<div class="game-card" data-category="working">
  ...
  <div class="game-info">
    <h3 class="game-title"><a href="https://github.com/felix86-emu/compatibility-list/issues/158">Slay The Spire 2</a></h3>
    <span class="status green">Working</span>
  </div>
</div>
<div class="game-card" data-category="working">
...
<div class="game-card" data-category="working">
  ...
  <script>
    ...
    function render() {
      ...
      for (let i = gamesToShow.length; i < gamesPerPage; i++) {
        const filler = document.createElement('div');
        filler.className = 'game-card placeholder';
        filler.setAttribute('aria-hidden', 'true');
        filler.innerHTML = '<div class="game-image-container"></div><div class="game-info"><h3 class="game-title">&nbsp;</h3><span class="status">&nbsp;</span></div>';
